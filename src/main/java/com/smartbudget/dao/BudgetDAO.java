...
public class BudgetDAO {
    ...
    // FIXED: Explicitly added <Budget> generic parameter mapping type safety
    ...
    public double getSpentForPeriod(int userId, int month, int year) {
        // Exam Tip: EXTRACT works perfectly in standard SQL, but if your local testing DB uses H2 or SQLite, 
        // fallback to standard date functions if you encounter errors.
